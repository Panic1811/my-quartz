...
**Definition:** The degree to which a game element visually or behaviorally _suggests_ its function or how the player should interact with it.  
**Example (Game/Scenario):** In _Portal_, a glowing portal surface signals it’s usable. In _Overwatch_, flying heroes like Pharah afford the idea that you should shoot her down — it's visually obvious.
...
**Example:** A _Black Panther_ going unchecked in _Marvel Rivals_ feels oppressive, but mainly because players aren’t swapping or adapting — not because BP is mathematically dominant.
...
**Example:** _Zed_ feels unkillable to mid-elo players because they don’t recognize or time his ability windows — not because he has no counterplay.
...
**Example:** In _StarCraft_, fog of war creates deliberate asymmetry. In MOBAs, a stealth hero like _Evelynn_ preys on lower-elo players who don’t track vision or timers.
...
**Example:** It’s easy to know you need to shoot _Pharah_ in _Overwatch_, but less obvious how to stop _Sombra_ from hacking your backline.
...
**Example:** _Reinhardt_ becomes viable in _Overwatch_ not when he's buffed, but when his counters (like Pharah or Junkrat) fall out of favor.
...
**Example:** _Widowmaker_ in _Overwatch_ or _Apex Legends’_ _Valkyrie_ — high payoff, but only if your mechanics are top-tier.
