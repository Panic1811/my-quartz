...
## 1. Democracy Requires an _Informed_ Public
...
- **Key contrast:**
    ...
    - Companies = optimize for _speed and precision_.
    - Countries = optimize for _stability and legitimacy_.
---
...
- Strength: represents citizens _and_ raises decision quality.
...
**Takeaway:**  
Democracy isn’t the most efficient system — it’s the most _forgiving_.  
It survives bad leaders, corrects itself over time, and anchors legitimacy in consent.  
Efficiency matters, but _resilience_ is what keeps societies alive.